...
@pytest.fixture()
def base_request(mock_client: MockClient) -> MockRequest: #pylint: disable=redefined-outer-name
...
def test_base_request_init(base_request: MockRequest): #pylint: disable=redefined-outer-name
...
def test_base_request_parse_options(base_request: MockRequest): #pylint: disable=redefined-outer-name
    """Tests parse options
...
def test_base_request_send_request(mock_client: MockClient, base_request: MockRequest): #pylint: disable=redefined-outer-name
...
def test_base_request_send_request_invalid_method(base_request: MockRequest): #pylint: disable=redefined-outer-name
